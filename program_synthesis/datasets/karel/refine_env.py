...
#import .mutation
from datasets import executor as executor_mod
from datasets.karel import parser_for_synthesis, mutation
from datasets.karel.mutation import *
...
class MutationActionSpace(gym.Space):
    ...
    def sample_parameters(self, action_type):
        ...
        if action_type == mutation.ADD_ACTION:
            ...
            raise ValueError("Invalid action id {}. Action id must be in the range [0, 8)".format(action_type))
